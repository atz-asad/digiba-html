$.fn.progressScroll=function(e){
    var r = $.extend({ width: 50, height: 50, borderSize: 5, mainBgColor: "rgba(var(--bs-primary-rgb), .8)", lightBorderColor: "var(--bs-white)", darkBorderColor: "var(--bs-primary)", fontSize: "20px" }, e);
    var t,
        i,
        n,
        o = this,
    ...
    this.updateProgress = function (e) {
        ...
        if (r <= 180) {
            ...
            $("." + s, a).css("background-image", "linear-gradient(" + (r - 90) + "deg, transparent 50%, var(--bs-primary) 50%),linear-gradient(90deg, var(--bs-white) 50%, transparent 50%)");
        }
        $("." + l, a).text();
    };
    //e+"%"
